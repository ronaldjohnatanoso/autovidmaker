...
# Watermark constants
ENABLE_WATERMARK = False  # NEW: Enable/disable watermark entirely
...
class SegmentProcessor:
    ...
    def _create_segment_watermark(self, duration):
        ...
        try:
            # Check if watermark is disabled or text is empty
            if not ENABLE_WATERMARK or not WATERMARK_TEXT.strip():
                return None
